...
The fundamental data structure in \mfnet is the tensor. In this context, a tensor is simply a \mono{numpy} array with a fixed data type of \mono{numpy.float64}. Tensors are used throughout \mfnet to represent inputs, outputs, intermediate activations, weights, and gradients within the \acl{NN}.
