...
\begin{align*}
    \J(\hat{Y}, \tilde{Y}) &= \frac{1}{2m} \sum_{i=1}^{m} (\hat{Y}_i - \tilde{Y}_i)^2\\
    &\;\begin{aligned}
        = \frac{1}{8} \left[\right.&(1 - 1)^2 + (1 - 1)^2 + (1 - 1)^2 + (1 - 1)^2 + \\
...
\begin{equation*}
    \frac{\partial \J}{\partial \hat{Y}} = \frac{1}{m} \left(\hat{Y} - \tilde{Y}\right) = \frac{1}{4} \mqty[
