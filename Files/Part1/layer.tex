...
In \mfnet, a layer is a fundamental building block of the \acl{NN}. Each layer performs a specific transformation on the input data. The two main types of layers implemented in \mfnet are Linear layers and Activation layers.
